...
class Client extends Frame implements ActionListener, WindowListener {
    ...
    public static void main(String args[]) {
        ...
        tf2.setBounds(130, 200, 230, 25);
        ta.setBounds(160, 300, 150, 100);
        btn.setBounds(50, 50, 70, 25);
        btn1.setBounds(50, 200, 70, 25);
        la.setBounds(130, 50, 150, 25);
        la1.setBounds(280, 50, 150, 25);
        la2.setBounds(200, 150, 150, 25);
        la3.setBounds(215, 250, 150, 25);
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            String st = ""; //перменная,в которую записываются введенные числа
            st += tf2.getText() + " ";
            os.write(st.getBytes()); // отправляем введенные данные. Тип string переводим в byte
 ...
 public void actionPerformed(ActionEvent arg0) {
     try {
         sock = new Socket(InetAddress.getByName(tf.getText()), Integer.parseInt(tf1.getText()));      //создается сокет по ip адрессу и порту
     }
